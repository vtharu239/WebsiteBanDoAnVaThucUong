...
namespace WebsiteBanDoAnVaThucUong.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Profile(EditAccountViewModel model)
        {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                WebsiteBanDoAnVaThucUong.Common.Common.SendMail("ShopOnline", "Quên mật khẩu", "Bạn click vào <a href='" + callbackUrl + "'>link này</a> để reset mật khẩu", model.Email);
